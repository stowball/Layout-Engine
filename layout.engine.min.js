...
*/
;var layoutEngine=(function(){var j=document.documentElement,c=j.style,m=" vendor-",b="ie",f="khtml",n="mozilla",g="opera",l="webkit",i=" browser-",e="android",h="chrome",d="wiiu",o=m,k;if("WebkitAppearance" in c){o+=l;var a=navigator.userAgent;if(a.indexOf("Android")>=0&&a.indexOf("Chrome")===-1){o+=i+e;k={vendor:l,browser:e}}else{if(!!window.chrome||a.indexOf("OPR")>=0){o+=i+h;k={vendor:l,browser:h}}else{if(!!window.wiiu){o+=i+d;k={vendor:l,browser:d}}else{k={vendor:l}}}}}else{if("MozAppearance" in c){o+=n;k={vendor:n}}else{if("-ms-scroll-limit" in c||"behavior" in c){o+=b+m+b;if("-ms-ime-align" in c){o+="-11";k={vendor:b,version:11}}else{if("-ms-user-select" in c){o+="-10";k={vendor:b,version:10}}else{if("fill" in c){o+="-9";k={vendor:b,version:9}}else{if("widows" in c){o+="-8";k={vendor:b,version:8}}else{o+="-7";k={vendor:b,version:7}}}}}}else{if("OLink" in c||!!window.opera){o+=g;if("OMiniFold" in c){o+="-mini";k={vendor:g,version:"mini"}}else{k={vendor:g}}}else{if("KhtmlUserInput" in c){o+=f;k={vendor:f}}else{return false}}}}}j.className+=o;return k})();